...
import com.example.layoutanimation.databinding.FragmentItemListBinding;
import com.example.layoutanimation.databinding.ItemListContentBinding;
...
public class ItemListFragment extends Fragment {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final List<kmObject> mValues;
        private final View mItemDetailFragmentContainer;

        SimpleItemRecyclerViewAdapter(List<kmObject> items,
                                      View itemDetailFragmentContainer) {
            mValues = items;
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                holder.itemView.setOnContextClickListener(v -> {
                    kmObject item =
                            (kmObject) holder.itemView.getTag();
                    Toast.makeText(
